...
# Identity
vgg16_model = build_network('VGG16', normalization_layer_name=None)
assert_norm_layer('VGG16', vgg16_model, nn.Identity)
resnet50_model = build_network('ResNet50', normalization_layer_name=None)
assert_norm_layer('ResNet50', resnet50_model, nn.Identity)

# BN
vgg16_model = build_network('VGG16', normalization_layer_name='bn')
assert_norm_layer('VGG16', vgg16_model, nn.BatchNorm2d)
resnet50_model = build_network('ResNet50', normalization_layer_name='bn')
assert_norm_layer('ResNet50', resnet50_model, nn.BatchNorm2d)

# GN
vgg16_model = build_network('VGG16', normalization_layer_name='gn')
assert_norm_layer('VGG16', vgg16_model, GroupNorm2d)
resnet50_model = build_network('ResNet50', normalization_layer_name='gn')
assert_norm_layer('ResNet50', resnet50_model, GroupNorm2d)

# GNPlusSequentialBNFirst
vgg16_model = build_network('VGG16', normalization_layer_name='gn_plus_sequential_bn_first')
assert_norm_layer('VGG16', vgg16_model, GNPLusSequentialBNFirst)
resnet50_model = build_network('ResNet50', normalization_layer_name='gn_plus_sequential_bn_first')
assert_norm_layer('ResNet50', resnet50_model, GNPLusSequentialBNFirst)

# GNPlusSequentialGNFirst
vgg16_model = build_network('VGG16', normalization_layer_name='gn_plus_sequential_gn_first')
assert_norm_layer('VGG16', vgg16_model, GNPlusSequentialGNFirst)
resnet50_model = build_network('ResNet50', normalization_layer_name='gn_plus_sequential_gn_first')
assert_norm_layer('ResNet50', resnet50_model, GNPlusSequentialGNFirst)

# GNPlusParallel
vgg16_model = build_network('VGG16', normalization_layer_name='gn_plus_parallel')
assert_norm_layer('VGG16', vgg16_model, GNPlusParallel)
resnet50_model = build_network('ResNet50', normalization_layer_name='gn_plus_parallel')
...
train, _ = build_data_loader('imagenet_mini', 8)
for im, label in train:
    assert len(im) == 8
    break
